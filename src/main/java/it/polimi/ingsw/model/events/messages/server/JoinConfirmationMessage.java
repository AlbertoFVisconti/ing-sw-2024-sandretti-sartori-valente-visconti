...
/**
 * Message that the Server sends to a Client to confirm that it was successfully added to a game.
 * The message also holds the player's identifier that the client needs to play the game.
 */
