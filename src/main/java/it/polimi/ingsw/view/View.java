...
public class View implements VirtualView {
     ...
     */
    public synchronized void forwardMessage(ServerMessage message) {
        try {
    ...
    @Override
    public synchronized void setController(VirtualController controller) {}
     ...
     */
    @Override
    public synchronized void setPlayerIdentifier(String playerIdentifier) {
     ...
     */
    @Override
    public synchronized void setStartingCard(StartCard card) {
     ...
     */
    @Override
    public synchronized void setCommonGoals(Goal[] goals) {
     ...
     */
    @Override
    public synchronized void setAvailablePrivateGoals(Goal[] goals) {
     ...
     */
    @Override
    public synchronized void setDefinitivePrivateGoal(Goal goal) {
     ...
     */
    @Override
    public synchronized void setPlayersCard(String playerNickname, PlayCard card, int index) {
     ...
     */
    @Override
    public synchronized void setVisibleCard(PlayCard card, int index) {
     ...
     */
    @Override
    public synchronized void setDeckTopResource(Resource resource, int index) {
        VirtualDeck deck;
        if (index == 0) {
     ...
     */
    @Override
    public synchronized void placeCardOnPlayersBoard(String playerNickname, CardSlot cardSlot, CardLocation location) {
        boolean found = false;
     ...
     */
    @Override
    public synchronized void updateGameList(Set<String> availableGames) {
     ...
     */
    @Override
    public synchronized void confirmJoin(String nickname, GameData savings) {
     ...
     */
    @Override
    public synchronized void updatePlayersList(String[] nicknames, PlayerColor[] colors) {
     ...
     */
    @Override
    public synchronized void updateGameStatus(GameStatus gameStatus, TurnStatus turnStatus, String playersTurn) {
     ...
     */
    @Override
    public synchronized void updateScore(ScoreBoard scoreBoard) {
     ...
     */
    @Override
    public synchronized void ping(boolean isAnswer) {
     ...
     */
    @Override
    public synchronized void sendChatMsg(ChatMessage chatMessage, boolean isPrivate) {
        if (isPrivate) {
     ...
     */
    public synchronized Set<PlayerColor> getAvailableColors() {
     ...
     */
    public synchronized Game getGameModel() {
        return gameModel;
    }
