...
class ScoreBoardTest {
    ...
    @Test
    void getScore() {
        assertEquals(0, s1.getScore("p0-s1"));

        assertEquals(0,s2.getScore("p0-s2"));
    ...
    void copyScore() {
        ...
        assertEquals(0, n2.getScore("p0-s2"));
